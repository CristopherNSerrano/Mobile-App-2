...
const BusinessProfileScreen = () => {
  ...
  // Products Array
  const [products, setProducts] = useState<Array<{ id: number; name: string; price: string; image: string }>>([
    {
      id: 1,
      name: 'Product One',
      price: '$49.99',
  ...
  // Reviews Array
  const [reviews, setReviews] = useState<Array<{ id: number; avatar: string; name: string; rating: number; text: string }>>([
    {
      id: 1,
  ...
  const handleBuyProduct = (product: { id: number; name: string; price: string; image: string }) => {
            ...
            <TouchableWithoutFeedback>
              <View style={styles.fullScreenContainer}>
                ...
                <FlatList
                  ...
                  scrollToIndex={(index) => mediaScrollRef.current.scrollToIndex({ index })}
